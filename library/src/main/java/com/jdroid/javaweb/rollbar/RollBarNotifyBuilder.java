...
public class RollBarNotifyBuilder {
    ...
    public String build() throws JSONException, UnknownHostException {
		...
		data.put("code_version", Application.get().getAppContext().getAppVersion());
        ...
        // server data
        data.put("server", getServerData());

        // notifier data
        data.put("notifier", getNotifierData());
    ...
    private JSONObject getNotifierData() throws JSONException {
        ...
        notifier.put("name", "jdroid");
        // TODO Put jdroid version here
